  ...
  return (
    <>
      <main className="text-center mx-auto mt-5 col-10 col-md-8">
        <div className="d-flex flex-column flex-lg-row">
          ...
          <div className="col-6 mx-auto px-lg-3">
            <div id="bio-container">
              <p>
                I moved to Luxembourg in September 2021 and have since taken
                steps to make web development my full-time career. Before living
                in Luxembourg, I was a law student at the University of
                Edinburgh where I studied Law Tech and Data Protection in
              ...
              <div>
                ...
                <svg
                  ...
                  width="48"
                  height="48"
                  viewBox="0 0 139.359 95.416"
                >
                  <path
                    fill="#fb503b"
                    d="M138.805,44.568c-.994-.994-13.748-17.061-15.9-19.712-2.319-2.65-3.313-2.153-4.8-1.988s-17.558,2.982-19.38,3.147c-1.822.331-2.982.994-1.822,2.65.994,1.491,11.6,16.4,13.914,19.877l-42.239,10.1L35.113,2.494C33.788.507,33.456-.156,30.475.01S4.137,2.163,2.481,2.163C.825,2.329-1,2.991.659,6.967S28.818,67.923,29.481,69.58s2.65,4.307,7.123,3.313c4.638-1.16,20.54-5.3,29.319-7.62,4.638,8.282,13.914,25.178,15.736,27.662,2.319,3.313,3.975,2.65,7.454,1.656,2.816-.828,43.4-15.4,45.221-16.233s2.982-1.325,1.656-3.147c-.994-1.325-11.6-15.736-17.227-23.19,3.81-.994,17.558-4.638,19.049-5.135,1.656-.5,1.988-1.325.994-2.319ZM62.112,60.3c-.5.166-24.184,5.8-25.343,6.129-1.325.331-1.325.166-1.325-.331C35.113,65.6,7.285,7.961,6.788,7.3c-.331-.663-.331-1.325,0-1.325S29.149,3.985,29.812,3.985c.828,0,.663.166.994.663,0,0,30.975,53.5,31.472,54.331.663.828.331,1.16-.166,1.325ZM128.7,72.727c.331.663.828.994-.5,1.325-1.159.5-39.92,13.583-40.748,13.914s-1.325.5-2.319-.994-13.583-23.19-13.583-23.19L112.8,53.015c.994-.331,1.325-.5,1.988.5.663,1.16,13.583,18.718,13.914,19.215Zm2.65-29.153c-.994.166-16.067,3.975-16.067,3.975l-12.423-16.9c-.331-.5-.663-.994.166-1.16s14.908-2.65,15.57-2.816,1.16-.331,1.988.828c.828.994,11.429,14.577,11.926,15.074s-.166.828-1.16.994Z"
                    transform="translate(-.006 .015)"
                  />
                </svg>
              </div>
        ...
        <p>
          You can view an interactive version of my complete CV built with
          Notion by <a>clicking here!</a>
        </p>
      </main>
      <style jsx>{`
        img {
